                ...
                <CardContent className="w-full">
                    <ul className="activities w-full">
                        {activities.map(activity => {
                            if (!activity.hidden) {
                                return <ActivityItem fetchActivities={updateActivities} key={activity.id} activityId={activity.id} selectedActivities={selectedActivities} setSelectedActivities={setSelectedActivities} style={{ 'word-break': 'break-all;', "backgroundColor": (selectedActivities.includes(activity.id)) ? "hsl(var(--primary))" : "transparent" }} isEditing={isEditing}>{activity.name}</ActivityItem>
                            }
                        })}
